    ...
    <div className='fixed top-0 bottom-0 left-0 right-0 z-100 flex items-center justify-center bg-black/70'>
          <form className='flex bg-white rounded-xl max-w-4xl max-md:mx-2'>
                    ...
                    <div className='relative flex flex-col items-center md:w-1/2 p-8 md:p-10'>
                              <img src= {assets.closeIcon} alt="closeIcon" className='absolute top-4 right-4 h-4
                              w-4 cursor-pointer'/>
                              <p className='text-2xl font-semibold mt-6'>Register Your Hotel</p>
                               ...
                               <div className='w-full mt-4'>
                                        <label htmlFor="phone" className='font-medium text-gray-500'>Contact</label>
                                        <input id = 'phone' type="tel" placeholder='Type here...' className='border border-gray-200  rounded w-full px-3  py-2.5 mt-1 outline-indigo-500 font-light' required/>
                               </div>
                               <div className='w-full mt-4'>
                                ...
                                <div className='w-full  mt-4 max-w-60 mr-auto'>
                                        ...
                                        <select name="city" id="city" className='border border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light cursor-pointer' required>
