...
const ListRoom = () => {
  ...
  return (
    <div>
      <Title align= 'left' font= 'oufit' title = 'Room Listings' subTitle='View, edit, or manage all listed rooms. Keep the information up-to-date to provide the best experience for users.' />
              ...
              <table className='w-full'>
                <thead className='bg-gray-50'>
                  <tr>
                     ...
                     <th className='py-3 px-4 font-medium text-gray-800 text-center'>Action</th>
                  </tr>
                </thead>
               <tbody className='text-sm'>
                         {
                          rooms.map((item, index)=>(
                            <tr key={index}>
                               ...
                               <td className='py-3 px-4 text-gray-700 border-t border-gray-300'>₹ {item.pricePerNight.toFixed(2)}</td>
